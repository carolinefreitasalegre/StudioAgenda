...
public class RegistrarCliente : IRegistrarCliente
{
    ...
    public RegistrarCliente(IValidator<RequisicaoRegistrarCliente> validar, IUnitOfWork unitOfWork, IRegistrarClienteReposirory registrarCliente, ISenhaHash senhaHash, ILeituraClienteRepository leituraClienteRepository)
    {
        _validar = validar;
    ...
    {
        var resultado = await _validar.ValidateAsync(dados);
